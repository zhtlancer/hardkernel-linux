...
static const struct xpad_device {
	...
	{ 0x0738, 0xcb02, "Saitek Cyborg Rumble Pad - PC/Xbox 360", 0,
	  XTYPE_XBOX360 },
	{ 0x0738, 0xcb03, "Saitek P3200 Rumble Pad - PC/Xbox 360", 0,
	  XTYPE_XBOX360 },
	...
	{ 0x0e6f, 0x0113, "Afterglow AX.1 Gamepad for Xbox 360", 0,
	  XTYPE_XBOX360 },
	...
	{ 0x1bad, 0xf023, "MLG Pro Circuit Controller (Xbox)", 0,
	  XTYPE_XBOX360 },
	...
	{ 0x24c6, 0x5303, "Xbox Airflo wired controller", 0,
	  XTYPE_XBOX360 },
	{ 0x24c6, 0x541a, "PowerA Xbox One Mini Wired Controller", 0,
	  XTYPE_XBOXONE },
	{ 0x24c6, 0x543a, "PowerA Xbox One wired controller", 0,
	  XTYPE_XBOXONE },
...
#define XPAD_XBOXONE_VENDOR_PROTOCOL(vend, pr) \
	.match_flags = \
	USB_DEVICE_ID_MATCH_VENDOR | USB_DEVICE_ID_MATCH_INT_INFO, \
	.idVendor = (vend), \
	.bInterfaceClass = USB_CLASS_VENDOR_SPEC, \
...
static void xpad_irq_in(struct urb *urb)
{
	 ...
	 */
	print_hex_dump(KERN_DEBUG, "xpad-dbg: ", DUMP_PREFIX_OFFSET,
			32, 1, xpad->idata, XPAD_PKT_LEN, 0);
#endif
