...
int usbio_sensor_init(struct usbio *usbio)
{
	...
	input_set_abs_params(input_dev, ABS_X, USBIO_SENSOR_MIN_X,
			USBIO_SENSOR_MAX_X, 0, 0);
	input_set_abs_params(input_dev, ABS_Y, USBIO_SENSOR_MIN_Y,
			USBIO_SENSOR_MAX_Y, 0, 0);
	input_set_abs_params(input_dev, ABS_Z, USBIO_SENSOR_MIN_Z,
			USBIO_SENSOR_MAX_Z, 0, 0);
